...
![一份代码库对应多份部署](12-factor应用/codebase-deploys-20200510232739810.png)
...
![一种部署附加4个后端服务](12-factor应用/attached-resources-20200510232853265.png)
...
![代码被构建，然后和配置结合成为发布版本](12-factor应用/release-20200510232904825.png)
