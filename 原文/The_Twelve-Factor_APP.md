...
![One codebase maps to many deploys](The_Twelve-Factor_APP/codebase-deploys.png)
...
![A production deploy attached to four backing services.](The_Twelve-Factor_APP/attached-resources.png)
...
![Code becomes a build, which is combined with config to create a release.](The_Twelve-Factor_APP/release.png)
...
![Scale is expressed as running processes, workload diversity is expressed as process types.](The_Twelve-Factor_APP/process-types.png)
