...
## 设计原则
* [大规模服务的经验 - Eric Brewer, UC Berkeley & Google](https://people.eecs.berkeley.edu/~brewer/papers/GiantScale-IEEE.pdf)
...
* [分布式缓存](https://www.wix.engineering/single-post/scaling-to-100m-to-cache-or-not-to-cache)
	...
	* [Trivago减少50%Memcached内存使用](http://tech.trivago.com/2017/12/19/how-trivago-reduced-memcached-memory-usage-by-50/)
	...
	* [Pycache: In-process Caching at Quoraji](https://engineering.quora.com/Pycache-lightning-fast-in-process-caching)
...
* [分布式监控与告警](https://www.oreilly.com/ideas/monitoring-distributed-systems)
    * [Alibaba监控系统](https://www.usenix.org/conference/srecon18asia/presentation/xinchi)
    * [Dailymotion实时用户监控](https://medium.com/dailymotion/real-user-monitoring-1948375f8be5)
...
* [分布式消息](https://arxiv.org/pdf/1704.00411.pdf)
    ...
    * [事件驱动消息](https://martinfowler.com/articles/201701-event-driven.html)
		...
		* [at mytaxi事件源](https://inside.mytaxi.com/event-sourcing-an-evolutionary-perspective-31e7387aa6f1)
...
* [分布式搜索](http://nwds.cs.washington.edu/files/nwds/pdf/Distributed-WR.pdf)
	...
	* [eBay的搜索架构](http://www.cs.otago.ac.nz/homepages/andrew/papers/2017-8.pdf)
	* [Box的搜索架构](https://medium.com/box-tech-blog/scaling-box-search-using-lumos-22d9e0cb4175)
...
* [分布式存储](http://highscalability.com/blog/2011/11/1/finding-the-right-data-solution-for-your-application-in-the.html)
	...
	* [对象存储](http://www.datacenterknowledge.com/archives/2013/10/04/object-storage-the-future-of-scale-out)
		...
		* [Yahoo云对象存储](https://yahooeng.tumblr.com/post/116391291701/yahoo-cloud-object-store-object-storage-at)
...
* [非关系数据库](https://www.thoughtworks.com/insights/blog/nosql-databases-overview)
	* [KV数据库](http://www.cs.ucsb.edu/~agrawal/fall2009/dynamo.pdf)
		* [DynamoDB在 Nike](https://medium.com/nikeengineering/becoming-a-nimble-giant-how-dynamo-db-serves-nike-at-scale-4cc375dbb18e)
...
* [自动扩容](https://medium.com/@BotmetricHQ/top-11-hard-won-lessons-learned-about-aws-auto-scaling-5bfe56da755f)
	* [Pinterest自动扩容](https://medium.com/@Pinterest_Engineering/auto-scaling-pinterest-df1d2beb4d64)
...
* [GC性能优化](https://confluence.atlassian.com/enterprise/garbage-collection-gc-tuning-guide-461504616.html)
	* [LinkedIn Java应用GC优化](https://engineering.linkedin.com/garbage-collection/garbage-collection-optimization-high-throughput-and-low-latency-java-applications)
...
* [Performance Optimization on Image, Video, Page Load](https://developers.google.com/web/fundamentals/performance/why-performance-matters/)
	...
	* [Pinterest提升GIF性能](https://medium.com/@Pinterest_Engineering/improving-gif-performance-on-pinterest-8dad74bf92f1)
	...
	* [Zillow提升主页性能](https://www.zillow.com/engineering/improving-homepage-performance/)
...
* [Medium技术栈](https://medium.engineering/the-stack-that-helped-medium-drive-2-6-millennia-of-reading-time-e56801f7c492)
...
* [Code Review](https://ai.google/research/pubs/pub47025)
	* [Palantir的Code Review](https://medium.com/@palantir/code-review-best-practices-19e02780015f)
	* [LINE的Code Review](https://engineering.linecorp.com/en/blog/effective-code-review/)
	* [Medium的Code Reviews](https://medium.engineering/code-reviews-at-medium-bed2c0dce13a)
	* [LinkedIn的Code Review](https://engineering.linkedin.com/blog/2018/06/scaling-collective-code-ownership-with-code-reviews)
	* [Disney的Code Review](https://medium.com/disney-streaming/the-secret-to-better-code-reviews-c14c7884b9ac)
